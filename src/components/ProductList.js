              ...
              <Col xs={12} sm={6} md={6} lg={3} key={p.id}>
                <Card key={p.id} style={{ margin: '0.2rem' }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Title className='card-text-formatter'>{p.manufacture}</Card.Title>
                    <Card.Title className='card-text-formatter'><ReactStars edit={false} size={25} value={p.rating} /></Card.Title>
